...
int main() {
    ...
    printf("INT_MAX+1:\t%d\n",INT_MAX+1); //viene stampato il numero più piccolo rappresentabile come intero.
    ...
    // L'operazione sotto genererà un "inf" (infinito) e non un numero negativo
    ...
    printf("\n%f\n", 0.0/0); // il risultato non è definito quindi dà NAN
    printf("%f\n", 1.0/0);
    printf("%f\n", (-1.0)/0);
    printf("%f\n", 1/INFINITY);
}
