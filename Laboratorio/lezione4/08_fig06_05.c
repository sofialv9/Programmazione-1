...
#define FREQUENCY_SIZE 16 // 16 perché i voti vanno da 0 a 15
...
int main(void) {
   ...
   for (size_t answer = 0; answer < RESPONSES_SIZE; ++answer) {
      ++frequency[responses[answer]]; //gli indici di frequency corrispondono ai valori presenti nell'array responses agli indici con valore answer.
   } 
