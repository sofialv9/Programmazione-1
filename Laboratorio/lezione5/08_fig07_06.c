...
void printCharacters(const char *sPtr); // puntatore di sola lettura (non permette di modificare il valore puntato)
...
// convert string to uppercase letters - modifica i dati puntati
...
// usando un puntatore costante si ha la garanzia che la funzione non modifichi i dati puntati
