// fig06_17.c
// Two-dimensional array manipulations - la matrice è un array di array - all'interno di ogni elemento di un array di righe c'è un array di colonne
#include <stdio.h>
#define STUDENTS 3
#define EXAMS 4
...
int main(void) {
   ...
   int studentGrades[STUDENTS][EXAMS] =
      {{77, 68, 86, 73},
       {96, 87, 89, 78},
       {70, 90, 86, 81}};
   // l'array STUDENTS contiene 3 elementi e ogni elemento contiene un array EXAMS di 4 elementi
   // a[1][1] ritorna il secondo elemento della seconda riga - il primo indice dice quale elemento (riga) cercare nel primo array, il secondo quale elemento cercare nell'array selezionato (colonna)
...
int minimum(const int grades[][EXAMS], size_t pupils, size_t tests) {
   ...
   // loop through rows of grades - servono n cicli annidati co n = dimensione array
...
// Print the array
// La prima dimensione di un array può non essere specificata ma le altre dalla seconda in poi si
void printArray(const int grades[][EXAMS], size_t pupils, size_t tests) {
   // output column heads
   printf("%s", "                 [0]  [1]  [2]  [3]");
