...
// function prototypes
void modifyArray(int b[], size_t size); // modifica i valori nell'array in quanto questo viene passato per riferimento
void modifyElement(int e); //non modifica l'elemento dell'array in quanto questo viene passato per valore 
