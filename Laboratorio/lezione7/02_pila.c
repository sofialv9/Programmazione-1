...
// La pila è una lista in cui si possono fare inserimenti o cancellazioni solo dalla testa

struct stackNode {
    char* name; // allocazione dinamica - non si conosce a priori la lunghezza della stringa - si alloca solo lo spazio che serve realmente per efficienza computazionale
    struct stackNode *next;
};

typedef struct stackNode StackNode;

// Funzione di utilità per copiare il contenuto della stringa in una stringa allocata dinamicamente
