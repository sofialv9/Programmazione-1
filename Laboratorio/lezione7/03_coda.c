...
// La coda è una lista in cui si possono fare inserimenti dalla testa e rimozioni dalla coda
...
// Inserisce nodo in coda
bool enqueue(QueueNode **head, QueueNode **tail, char* data) {
    // Crea nuovo nodo
    QueueNode *newNode = malloc(sizeof(QueueNode));

    // se l'allocazione non è andata a buon fine (la memoria è piena)
    if(newNode == NULL)
