...
// La lista doppiamente concatenata si può scorrere sia da destra a sinistra che da sinistra a destra - ogni nodo ha un riferimento sia al nodo precedente che a quello successivo - utile quando si deve accedere solo dalla coda (non è necessario scorrere tutta la lista) o si deve presentare la lista in entrambi i modi
