#include <stdio.h>
#include <stdbool.h> //senza questa direttiva, otterremmo un errore di compilazione - libreria necessaria per usare i valori booleani
...
int main(){
    ...
    char a = 'a'; // da non confondere con "a" (= stringa)
    unsigned char b = 12;
    ...
    // formato booleano (0 = false, tutti gli altri numeri = true)
    _Bool b1 = 0;
    ...
    // le variabili booleane possono essere utilizzate per effettuare controlli - stampa true
    if(b4) {
        printf("true\n");
    } else {
        printf("false\n");
    ...
    // esempio: bool c = (3>4) || (2<2) - stampa false
}
